...
```{r}
monthly_bt <- EDABUtilities::make_2d_summary_ts(data.in = c(here::here('data-raw','glorys_bottomT.nc')),
...
```{r}
daily_bS <- EDABUtilities::make_2d_summary_ts(data.in = c(here::here('data-raw','glorys_bottomS.nc')),
...
>>>>>>> 5d5d7654fa1dc95fe4d3c2e4605adc87452fa312
