...
hubert <- ncdf4::nc_open(here::here('data-raw/2026/duPontavice_bottom_temp_1959_2021.nc'))
fishbot <- ncdf4::nc_open(here::here('data-raw/2026/fishbot_2000_2026.nc'))

### HALIBUT
#not recognizing var.name as "temperature"

terra::rast(here::here('data-raw/2026','fishbot_2000_2026.nc'))

fishbot_halibut <- create_spatial_indicator(indicator_name = "fishbot_bottomT", 
                                      units = "degC",
...
bt_halibut <- create_spatial_indicator(indicator_name = "bottomT", 
                                            units = "degC",
                                            ...
                                            touches = TRUE,
                                            write.out = F)
write.csv(bt_halibut, here::here('data-raw/2026','halibut_hubert_bottomT.csv'), row.names = FALSE)

glorys_halibut <- create_spatial_indicator(indicator_name = "bottomT", 
                                       units = "degC",
                                       ...
                                       touches = TRUE,
                                       write.out = F)
write.csv(glorys_halibut, here::here('data-raw/2026','halibut_glorys_bottomT.csv'), row.names = FALSE)

### POLLOCK
bt_pollock <- create_spatial_indicator(indicator_name = "bottomT", 
                                       units = "degC",
                                       data.in = c(here::here('data-raw/2026','duPontavice_bottom_temp_1959_2021.nc')),
                                       file.time = 'annual',
                                       ...
                                       shp.file = here::here('data-raw/shapefiles','BTS_STRATA.shp'),
                                       var.name = "sea_water_temperature_at_sea_floor",
                                       area.names = c("01130", "01140", "01150", "01160", "01170", "01180",
                                                      "01190", "01200", "01210", "01220", "01230", "01240",
                                                      "01250", "01260", "01270", "01280", "01290", "01300",
                                       ...
                                       touches = TRUE,
                                       write.out = F)
write.csv(bt_pollock, here::here('data-raw/2026','pollock_hubert_bottomT.csv'), row.names = FALSE)

glorys_pollock <- create_spatial_indicator(indicator_name = "bottomT", 
                                           units = "degC",
                                           data.in = c(here::here('data-raw/2026','glorys_2021_2026.nc')),
                                           file.time = 'annual',
                                           ...
                                           touches = TRUE,
                                           write.out = F)
write.csv(glorys_pollock, here::here('data-raw/2026','pollock_glorys_bottomT.csv'), row.names = FALSE)


### RED HAKE (AS UNIT, NEED STRATA FOR N/S)
bt_redhake <- create_spatial_indicator(indicator_name = "bottomT", 
                                       units = "degC",
                                       data.in = c(here::here('data-raw/2026','duPontavice_bottom_temp_1959_2021.nc')),
                                       file.time = 'annual',
                                       ...
                                       touches = TRUE,
                                       write.out = F)
write.csv(bt_redhake, here::here('data-raw/2026','redhake_hubert_bottomT.csv'), row.names = FALSE)

glorys_redhake <- create_spatial_indicator(indicator_name = "bottomT", 
                                           units = "degC",
                                           data.in = c(here::here('data-raw/2026','glorys_2021_2026.nc')),
                                           file.time = 'annual',
                                           ...
                                           touches = TRUE,
                                           write.out = F)
write.csv(glorys_redhake, here::here('data-raw/2026','redhake_glorys_bottomT.csv'), row.names = FALSE)

### SILVER HAKE (AS UNIT, NEED STRATA FOR N/S)
bt_silverhake <- create_spatial_indicator(indicator_name = "bottomT", 
                                       units = "degC",
                                       data.in = c(here::here('data-raw/2026','duPontavice_bottom_temp_1959_2021.nc')),
                                       file.time = 'annual',
                                       ...
                                       touches = TRUE,
                                       write.out = F)
write.csv(bt_silverhake, here::here('data-raw/2026','silverhake_hubert_bottomT.csv'), row.names = FALSE)

glorys_silverhake <- create_spatial_indicator(indicator_name = "bottomT", 
                                           units = "degC",
                                           data.in = c(here::here('data-raw/2026','glorys_2021_2026.nc')),
                                           file.time = 'annual',
