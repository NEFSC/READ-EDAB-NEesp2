...
sst_monthly <- create_spatial_indicator(indicator_name = 'sst',
                                units = 'degC',
...
sst_test <- create_spatial_indicator(indicator_name = 'sst',
                                units = 'degC',
                                data.in = sst_test,
...
sst_acspo <- create_spatial_indicator(indicator_name = 'sst',
                                     units = 'degC',
