...
#' @param widths A numeric vector of column widths (in inches). Default is c(0.9, 0.75, 3, 3)
#' @return A flextable
#' @export

rpt_card_table <- function(data, widths = c(0.9, 0.75, 3, 3)) {
  ...
  tbl <- flextable::width(tbl, j = 1:4, width = widths, unit = "in")
...
format_tbl_data <- function(file, term_year, dir) {
